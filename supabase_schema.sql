...
BEGIN
    ...
    -- Insert into brain_tiles in a random order with sequential IDs 1 to 100
    INSERT INTO public.brain_tiles (id, value, expression)
    SELECT row_number() OVER (ORDER BY random()), value, expression FROM temp_tiles;
END $$;
